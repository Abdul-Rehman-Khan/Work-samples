...
export function changeActivationStatus(payload) {
    return {
        type: Types.TOPIC_CONFIG_LIST_STATUS_CHANGE,
        payload
    };
}
...
export function blurTitle() {
    return {
        type: Types.TOPIC_CONFIG_LIST_TITLE_BLUR
    };
}
...
export function selectTitleForEdit(index) {
    return {
        type: Types.TOPIC_CONFIG_LIST_TITLE_CLICK,
        payload: index
    };
}
...
export function cancelChanges() {
    return {
        type: Types.TOPIC_CONFIG_LIST_CANCEL
    };
}
...
export function fetchTopicConfigList() {
    return dispatch => {
        dispatch({
            type: Types.TOPIC_CONFIG_LIST_FETCH
        });
        return api
            .getTopicList()
            .then(response => {
...
export function createAndUpdateTopics(topicConfigList) {
    return dispatch => {
        dispatch({
            type: Types.TOPIC_CONFIG_LIST_SAVE
        });
        return api
